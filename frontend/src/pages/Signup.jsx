    ...
    <div className="flex items-center justify-center min-h-screen bg-[#86DEB7] px-4">
      <div className="p-8 sm:p-12 rounded-xl shadow-lg bg-[#D6D3F0] w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
          <div>
            <label className="block text-sm sm:text-lg font-medium text-black mb-1">Username</label>
            <input
              type="text"
              value={username}
          ...
          <div>
            <label className="block text-sm sm:text-lg font-medium text-black mb-1">Email</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block text-sm sm:text-lg font-medium text-black mb-1">Password</label>
            <input
              type="password"
              value={password}
